...
train = pd.read_csv(r'C:/Users/ADMIN/Documents/GitHub/Heart-Disease-Pred/Data/train.csv')
test = pd.read_csv(r'C:/Users/ADMIN/Documents/GitHub/Heart-Disease-Pred/Data/test.csv')
